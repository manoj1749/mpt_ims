...
class _SupplierMasterPageState extends ConsumerState<SupplierMasterPage> {
  ...
  Future<void> _openConfigureSlabsDialog() async {
    ...
    final partialController = TextEditingController(text: '0-5=4.5\n5.01-10=4.0\n10.01-20=3.0\n20.01-30=2.0\n30.01-100=1.0');
    final recheckController = TextEditingController(text: '0-5=3.0\n5.01-10=2.5\n10.01-20=2.0\n20.01-100=1.5');
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                    ...
                    builder: (context, setState) {
                      ...
                      void onCodeChanged(String value) {
                        ...
                        final exact = suppliers
                            .where((s) => s.vendorCode.toLowerCase() ==
                                value.toLowerCase())
                            .firstOrNull;
                        if (exact != null) {
                          setState(() {
                  ...
                  const SizedBox(height: 16),
                  const Text('Partial Acceptance Slabs (min-max=rating per line)'),
                  const SizedBox(height: 6),
                  TextField(
              ...
              onPressed: () async {
                ...
                List<RatingRange> parseSlabs(String text) {
                  ...
                  for (final raw in lines) {
                    ...
                    slabs.add(RatingRange(minPercent: minP, maxPercent: maxP, rating: rating));
                  }
                  return slabs;
                }
                ...
                final lotAcc = double.tryParse(lotAcceptedController.text.trim()) ?? 5.0;
                final lotRej = double.tryParse(lotRejectedController.text.trim()) ?? 0.0;
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton.icon(
            ...
            label: const Text('Configure Slabs', style: TextStyle(color: Colors.white)),
          ),
          IconButton(
