...
class MaterialReturnDeliveryChallanListPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MaterialReturnDeliveryChallanListPage> createState() =>
      _MaterialReturnDeliveryChallanListPageState();
}

class _MaterialReturnDeliveryChallanListPageState
    extends ConsumerState<MaterialReturnDeliveryChallanListPage> {
  @override
  Widget build(BuildContext context) {
    final allDeliveryChallans = ref.watch(deliveryChallanListProvider);
    // Filter for material return delivery challans only
    final deliveryChallans = allDeliveryChallans.where((dc) => dc.dcType == 'material_return').toList();
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Material Return Delivery Challans'),
        actions: [
          IconButton(
