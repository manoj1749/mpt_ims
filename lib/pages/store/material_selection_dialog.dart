...
class MaterialSelectionDialogState
      ...
      PlutoColumn(
        ...
        renderer: (rendererContext) {
          return IconButton(
            ...
            onPressed: () =>
                _selectMaterial(rendererContext.cell.value as MaterialItem),
            color: Colors.blue,
  ...
  void _selectMaterial(MaterialItem material) {
    Navigator.of(context).pop([material]); // Return a list with one material
  }
